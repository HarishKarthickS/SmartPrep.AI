...
const en: LocaleType = {
  ...
  Auth: {
    ...
    TopTips:
      "🥳 SmartPrep AI launch promotion: Instantly unlock the latest models like OpenAI o1, GPT-4o, Claude-3.5!",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Use SmartPrep AI",
        Label: " (Most Cost-Effective Option)",
        SubTitle:
          "Maintained by SmartPrep, zero setup needed, unlock OpenAI o1, GPT-4o," +
          " Claude-3.5 and more",
        ChatNow: "Start Now",
      },
      AccessCode: {
